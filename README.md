...
### STEP 1. visualization of allele frequencies of single nucleotide polymorphisms within a given set of genes across 74 A. arenosa populations

### STEP 2. simple allele frequency difference-based selection scan across given set of genes

### STEP 3. visualization of outlier genes and SNPs identified in STEP 2
